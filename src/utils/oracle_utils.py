...
"""
Copied from https://github.com/lil-lab/newsroom/blob/master/newsroom/analyze/fragments.py
...
def cal_compression_ratio(text, summary):
    fg = Fragments(summary, text)
    comp_ratio = fg.compression()
    s = fg.coverage()
    c = fg.density()
    print(comp_ratio)
    print(s)
...
cal_compression_ratio("hello this is Sajad", "Well, my names is Sajad and I'm living in the US. Glad too see you all again!!")